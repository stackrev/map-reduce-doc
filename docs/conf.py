...
project = 'MapReduce Subnet'
copyright = '2023, Chain Dude'
author = 'Chain Dude'
...
htmlhelp_basename = 'mapReduceDoc'
...
latex_documents = [
    (master_doc, 'MapReduce Subnet.tex', 'MapReduce Subnet Documentation',
...
man_pages = [
    (master_doc, 'MapReduce', 'MapReduce Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MapReduce Subnet', 'MapReduce Subnet Documentation',
     author, 'MapReduce Subnet', 'One line description of project.',
     'Miscellaneous'),
]
